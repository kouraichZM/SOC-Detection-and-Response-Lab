...
This lab is conducted **entirely in an isolated environment** for defensive security learning purposes only.  
No systems or networks outside this lab were targeted.
